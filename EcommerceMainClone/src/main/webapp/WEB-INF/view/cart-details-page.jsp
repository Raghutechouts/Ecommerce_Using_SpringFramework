...
<h2>Your Cart Details</h2>
	<div
		...
		<c:forEach items="${cartData}" var="data">
					...
					<div class="card" style="border-radius: 10px;">
						...
						<div>
							<h5 class="text-dark mb-0">Total Quantity:${data.getQuantity()}</h5>
 							<a href="/EcommerceMain/pdp/${data.getProductId()}">Change Quantity</a>
 						</div><br>
						<div class="d-flex justify-content-between mb-2">
							...
							<div class="d-flex flex-row">
								<button type="button" class="btn btn-primary flex-fill me-1"
									...
									<a	style="color: black; text-align: center; padding: 12px; text-decoration: none" href="/EcommerceMain/order/${data.getId()}">ORDER NOW</a>
								</button>
								<button type="button" class="btn btn-danger flex-fill ms-1">
									<a
										...
										href="/EcommerceMain/removeCart/${data.getId()}">REMOVE FROM CART</a>
								</button>
							</div>
						</div>
					</div>
